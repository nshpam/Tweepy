...
class PullTwitterData():
   ...
   def __init__(self, insertion=False):
   ...
   def check_database(self, tweet_id):
      for doc in cursor:
         if tweet_id == doc['id']:
            return False
      return True
   ...
   def update_database(self, collection_variable, tweet_id, update_fav, update_retweet):
      for doc in cursor:
         if tweet_id == doc['id']:
            ...
            cmd = collection_variable.update(tweet_id, new_values)
            return cmd
   ...
   def search_twitter(self, api):
      ...
      for tweet in tweets_list:
         ...
         #read database
         if self.check_database(tweet_id) == False:
